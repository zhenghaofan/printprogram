...
define(['lib/bcmath'],function (bcmath){
	var PDF417 = {
		ROWHEIGHT: 4,
		QUIETH: 2,
		QUIETV: 2,
			...
			switch(mode) {
				...
				case 924: { // Byte Compaction mode latch
					...
					while ((codelen = code.length) > 0) {					
						...
						if (sublen == 6) {
							var t = bcmath.bcmul(''+this._ord(code.charAt(0)), '1099511627776');
							t = bcmath.bcadd(t, bcmath.bcmul('' + this._ord(code.charAt(1)), '4294967296'));
							t = bcmath.bcadd(t, bcmath.bcmul('' + this._ord(code.charAt(2)), '16777216'));
							t = bcmath.bcadd(t, bcmath.bcmul('' + this._ord(code.charAt(3)), '65536'));
							t = bcmath.bcadd(t, bcmath.bcmul('' + this._ord(code.charAt(4)), '256'));
							t = bcmath.bcadd(t, '' + this._ord(code.charAt(5)));
							do {
								var d = this._my_bcmod(t, '900');
								t = bcmath.bcdiv(t, '900');
								cw.unshift(d);
							} while (t != '0');
						} else {
